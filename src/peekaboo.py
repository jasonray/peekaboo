...
class Peekaboo:
    ...
    def start(self):
        ...
        processes = [
            { 'name':'Process-A', 'command':'python3 ./src/ghost.py -t 10 -s 2' },
            { 'name':'Process-B', 'command':'python3 ./src/ghost.py -t 120 -s 60' },
            { 'name':'Process-C', 'command':'python3 ./src/ghost.py -t 0 -s 60' }            
        ]
